...
export const RpcService = {
  ...
  // ----------------------------------------------------------------
  getEvmBalance: async (
    chain: "ETHEREUM" | "BASE" | "POLYGON" | "ARBITRUM" | "BSC" | "GNOSIS",
    address: string,
  ) => {
  ...
  getCw20Balance: async (
    ...
    try {
      ...
      console.error(
        `Error fetching CW20 balance for ${contractAddress}:`,
        error,
      );
      return 0;
    }
  ...
  getErc20Balance: async (
    ...
    try {
      ...
      console.error(
        `Error fetching ERC20 balance for ${contractAddress} on ${chain}:`,
        error,
      );
      return 0;
    }
