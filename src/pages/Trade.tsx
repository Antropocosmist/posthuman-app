...
export function Trade() {
    ...
    return (
        <div className="max-w-md mx-auto relative pt-8 pb-20">
            {/* Mode Switcher */}
            <div className="flex bg-black/40 p-1 rounded-full border border-white/10 mb-6 mx-4">
                <button
                    onClick={() => setTradeMode('cosmos')}
                    className={`flex-1 py-2 px-4 rounded-full text-sm font-bold transition-all ${tradeMode === 'cosmos'
                ...
                <button
                    ...
                    className={`flex-1 py-2 px-4 rounded-full text-sm font-bold transition-all ${tradeMode === 'evm'
                        ? 'bg-purple-600/20 text-purple-400 shadow-lg border border-purple-500/30'
                        : 'text-gray-500 hover:text-white hover:bg-white/5'
                        }`}
                >
                    Cross-Chain
            ...
            {tradeMode === 'evm' ? (
                <div className="px-4">
                    <JumperTrade />
                    <div className="mt-8 p-6 rounded-[2rem] bg-gradient-to-br from-purple-500/5 to-blue-500/5 border border-white/5 text-center">
                        <div className="flex items-center justify-center gap-2 text-purple-400 font-bold mb-2">
                            <Info className="w-5 h-5" />
                            <span>Powered by Jumper</span>
                        </div>
                        <p className="text-sm text-gray-400 leading-relaxed">
                            Access Ethereum, Solana, Base, Arbitrum and 20+ other chains with global liquidity.
                        </p>
                    </div>
                </div>
            ) : (
